document.addEventListener('DOMContentLoaded', function() {
    ...
    buyButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const whatsappNumber = '+2347037888622';
            const message = `Hello Israeli Doors, I'm interested in your ${productName}. Please send me more details and pricing information.`;
